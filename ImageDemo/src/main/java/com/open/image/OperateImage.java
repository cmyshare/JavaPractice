...
public class OperateImage {
         ...
         * @throws IOException
         */
        public byte[] cropImage(byte[] bytes,int[] position, String readImageFormat,String writeImageFormat) throws IOException{
            FileInputStream fis = null ;
            ImageInputStream iis =null ;
            InputStream is = null;
        ...
        public  boolean joinImageListVertical(String[] pics, String type, String dst_pic) {
            try {
                ...
                for (int i = 0; i < images.length; i++) {
                    ...
                    // 注意这里使用 images[i].getWidth() 而不是 dst_width 作为像素偏移量的宽度
